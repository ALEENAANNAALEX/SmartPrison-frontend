...
export default function ForgotPassword() {
    ...
    try {
      ...
      if (result.error) {
        if (result.error.includes('Supabase not configured')) {
          setError('Google sign-in not configured yet. Please use the forgot password form or set up Supabase.');
        } else {
  ...
  return (
    <div className="h-screen bg-gray-900 flex flex-col overflow-hidden">
            ...
            <div className="md:hidden bg-white border-t border-gray-200">
              <div className="px-2 pt-2 pb-3 space-y-1">
                ...
                <button
                  ...
                  className="block text-left w-full px-3 py-2 bg-black text-white rounded-lg hover:bg-gray-800 transition-colors duration-200 font-medium"
                >
                  Login
                </button>
              </div>
      ...
      {/* Main Content */}
      <div className="flex-1 relative flex items-center justify-center p-4 pt-20 pb-20">
        {/* Enhanced Background */}
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 opacity-5">
            <svg className="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
              <defs>
                <pattern id="forgot-grid" width="8" height="8" patternUnits="userSpaceOnUse">
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-300">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent placeholder-gray-400"
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-black text-white py-3 px-4 rounded-lg hover:bg-gray-800 focus:ring-2 focus:ring-black focus:ring-offset-2 transition-colors duration-200 font-medium disabled:opacity-50 disabled:cursor-not-allowed"
              >
      ...
      <footer className="bg-gray-900 text-white py-4 mt-auto flex-shrink-0">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
